...
class PembelianModel extends Model
{
    ...
    public function getPembelian()
    {
        ...
        $builder->select('pembelian.*, supplier.*');
        $builder->join('supplier', 'supplier.id_supplier=pembelian.id_supplier');
        $builder->join('detail_pembelian', 'detail_pembelian.id_pembelian=pembelian.id_pembelian');
        $query = $builder->get();
    ...
    public function getDasboardPembelian()
    {
        $builder = $this->db->table('pembelian');
        $query = $builder->countAllResults();
        return $query;
    ...
    public function getDetailPembelian($id_pembelian)
    {
        ...
        $builder->join('barang', 'barang.id_barang=detail_pembelian.id_barang');
